...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("UPRISING_M249.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("UPRISING_556.FireSil") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/lmgs/c_m249.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/lmgs/w_m249.mdl" -- Weapon world model path
...
--[[SPRINTING]]--
SWEP.RunSightsPos = Vector(-0.033, 0.107, -0.763)
SWEP.RunSightsAng = Vector(-18.401, 15.01, -34.377)
--[[IRONSIGHTS]]--
SWEP.data = {}
...
SWEP.IronSightTime = 0.5
	...
	SWEP.IronSightsPos = Vector(-3.3991, -1.2495, 1.4204)
	SWEP.IronSightsAng = Vector(0.1069, 0.0362, 0)

	SWEP.IronSightsPos_RDS = Vector(-3.3934, -1.3523, 0.5748)
	SWEP.IronSightsAng_RDS = Vector()

	SWEP.IronSightsPos_EOTECHL3 = Vector(-3.3834, -2.6905, 0.3948)
	SWEP.IronSightsAng_EOTECHL3 = Vector()

	SWEP.IronSightsPos_AIMP = Vector(-3.391, -2.4908, 0.6844)
	SWEP.IronSightsAng_AIMP = Vector()

	SWEP.IronSightsPos_COMPM4 = Vector(-3.3946, 3.5226, 0.159)
	SWEP.IronSightsAng_COMPM4 = Vector()

	SWEP.IronSightsPos_TF = Vector(-3.4016, -6.6173, 0.4199)
	SWEP.IronSightsAng_TF = Vector()

	SWEP.IronSightsPos_ELCAN = Vector(-3.3822, -1.4573, 0.6287)
	SWEP.IronSightsAng_ELCAN = Vector()

	SWEP.IronSightsPos_ACOG = Vector(-3.3838, -2.536, 0.5613)
	SWEP.IronSightsAng_ACOG = Vector()

	SWEP.IronSightsPos_HAMR = Vector(-3.384, -3.2248, 0.6333)
	SWEP.IronSightsAng_HAMR = Vector()

	SWEP.AltPos_HAMR = Vector(0, -2, -1.08)
	SWEP.AltAng_HAMR = Vector()

	SWEP.AltPos_ELCAN = Vector( 0, -3, -0.8 )
...
SWEP.ViewModelBoneMods = {
	["l_upperarm"] = { scale = Vector(0.8,0.8,0.8), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["r_upperarm"] = { scale = Vector(0.8,0.8,0.8), pos = Vector(0,0,0), angle = Angle(0, 0, 0) }
}
...
SWEP.VElements = {
["acog"] = { type = 'Model', model = "models/uprising/attachments/v/optics/acogmoh.mdl", bone = "sight", pos = Vector(-0, 0, -0.15), angle = Angle(), size = Vector(0.9,0.9,0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["elcan"] = { type = 'Model', model = "models/uprising/attachments/v/optics/elcan.mdl", bone = "sight", pos = Vector(-0, 0, -0.15), angle = Angle(), size = Vector(0.9,0.9,0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["hamr"] = { type = 'Model', model = "models/uprising/attachments/v/optics/hybrid.mdl", bone = "sight", pos = Vector(1, 0, -0), angle = Angle(), size = Vector(0.9,0.9,0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["rds"] = { type = 'Model', model = "models/uprising/attachments/v/rds/bo2rds.mdl", bone = "sight", pos = Vector(1, 0, -0.25), angle = Angle(), size = Vector(0.9,0.9,0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["aimpoint"] = { type = 'Model', model = "models/uprising/attachments/v/rds/aimpoint.mdl", bone = "sight", pos = Vector(1, 0, -0.1), angle = Angle(), size = Vector(0.9,0.9,0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["compm4"] = { type = 'Model', model = "models/uprising/attachments/v/rds/compm4.mdl", bone = "sight", pos = Vector(1, 0, -0.25), angle = Angle(), size = Vector(0.9,0.9,0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["eotechl3"] = { type = 'Model', model = "models/uprising/attachments/v/rds/eotechl3.mdl", bone = "sight", pos = Vector(1, 0, -0.15), angle = Angle(), size = Vector(0.9,0.9,0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["targetfinder"] = { type = 'Model', model = "models/uprising/attachments/v/rds/targetfinder.mdl", bone = "sight", pos = Vector(1, 0, -0.1), angle = Angle(), size = Vector(0.9,0.9,0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["suppressor"] = { type = 'Model', model = "models/uprising/attachments/v/muzzles/riflesilencer.mdl", bone = "muzzle", pos = Vector(-1.5, 0, 0), angle = Angle(), size = Vector(0.8,0.8,0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["laser"] = { type = 'Model', model = "models/uprising/attachments/v/lams/riflelaser.mdl", bone = "weapon_m249_dm", pos = Vector(0.6512, 5.4788, 1.9893), angle = Angle(90, -90, -90), size = Vector(0.8932, 0.8932, 0.8932), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["grip"] = { type = 'Model', model = "models/uprising/attachments/v/grips/grip.mdl", bone = "grip", pos = Vector(0, 0, 0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["afg"] = { type = 'Model', model = "models/uprising/attachments/v/grips/afg.mdl", bone = "grip", pos = Vector(0, 0, 0), angle = Angle(), size = Vector(0.9,0.9,0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
...
SWEP.Attachments = {
	...
	[1] = {
	header = "Sights",
	 offset = { 0, 0 }, atts = { "uprising_si_rds", "uprising_si_eotechl3", "uprising_si_aimpoint", "uprising_si_compm4",  "uprising_si_targetfinder", "uprising_si_elcan", "uprising_si_acog", "uprising_si_hybrid" }, order = 1 },
	[2] = {
	header = "Barrel",
...
SWEP.GripBoneMods = {
	...
	["j_shoulder_le"] = { scale = Vector(1, 1, 1), pos = Vector(1.832, 3.151, -0.158), angle = Angle(0, 0, 0) },
...
SWEP.InspectBoneMods = {
	["r_upperarm"] = { scale = Vector(0.8,0.8,0.8), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["l_upperarm"] = { scale = Vector(0.8,0.8,0.8), pos = Vector(-8, 10, -5), angle = Angle(0, 0, 0) }
}
