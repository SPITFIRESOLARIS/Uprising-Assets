...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("UPRISING_P90.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("UPRISING_P90.Firesil") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.SpreadMultiplierMax = 1.4--How far the spread can expand when you shoot. Example val: 2.5
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/smgs/c_p90.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/smgs/w_p90.mdl" -- Weapon world model path
...
SWEP.IronSightTime = 0.4
	...
	SWEP.IronSightsPos = Vector(-3.6204, -1.605, -0.2991)
	SWEP.IronSightsAng = Vector()

	SWEP.IronSightsPos_RDS = Vector(-3.61, -4.1575, -0.6516)
	SWEP.IronSightsAng_RDS = Vector()

	SWEP.IronSightsPos_EOTECHL3 = Vector(-3.5995, -6.1352, -0.7346)
	SWEP.IronSightsAng_EOTECHL3 = Vector()

	SWEP.IronSightsPos_AIMP = Vector(-3.6188, -5.9533, -0.3635)
	SWEP.IronSightsAng_AIMP = Vector()

	SWEP.IronSightsPos_TF = Vector(-3.6208, -10.0013, -0.5484)
	SWEP.IronSightsAng_TF = Vector()

	SWEP.IronSightsPos_ELCAN = Vector(-3.6107, -6.0475, -0.4719)
	SWEP.IronSightsAng_ELCAN = Vector()

	SWEP.IronSightsPos_ACOG = Vector(-3.6065, -6.7344, -0.5628)
	SWEP.IronSightsAng_ACOG = Vector()

	SWEP.IronSightsPos_HAMR = Vector(-3.6152, -6.6194, -0.4028)
...
SWEP.WorldModelBoneMods = {
	["muzzle"] = { scale = Vector(0.8,0.8,0.8), pos = Vector(0, 0, -0), angle = Angle(0, 0, 0) },
	["laser"] = { scale = Vector(0.6,0.6,0.6), pos = Vector(0, 0, 0), angle = Angle(180, 180,-90) },
...
["elcan"] = { type = 'Model', model = "models/uprising/attachments/v/optics/elcan.mdl", bone = "tag_eotech", pos = Vector(0, 0, -0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
...
["suppressor"] = { type = 'Model', model = "models/uprising/attachments/v/muzzles/smgsilencer.mdl", bone = "tag_flash", pos = Vector(-2, 0, 0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["laser"] = { type = 'Model', model = "models/uprising/attachments/v/lams/pistollaser.mdl", bone = "j_gun", pos = Vector(7.6408, -1.434, 3.2493), angle = Angle(0, 0, 90), size = Vector(0.6839, 0.6839, 0.6839), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
...
["laser_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "beam", rel = "laser", pos = Vector(0,0,0), angle = Angle(0, 00, 0), size = Vector(2, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false }
...
["laser"] = { type = 'Model', model = "models/uprising/attachments/v/lams/pistollaser.mdl", bone = "laser", rel = "ref", pos = Vector(0,0,0), angle = Angle(0,0,0), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {}, bonemerge = true,  active = false },
