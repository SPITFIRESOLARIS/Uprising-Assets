...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("UPRISING_USP45.Fire") -- This is the sound of the weapon, when you shoot.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/pistols/c_usp.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/pistols/w_usp.mdl" -- Weapon world model path
...
SWEP.IronSightTime = 0.4
	...
	SWEP.IronSightsPos = Vector(-1.8365, 4.3872, 1.3723)
	SWEP.IronSightsAng = Vector(-1.1279, -0.0717, 0)

	SWEP.IronSightsPos_RMR = Vector(-1.8366, 0.5281, 0.9668)
	SWEP.IronSightsAng_RMR = Vector(-1.3629, -0.1072, 0)

	SWEP.IronSightsPos_RDS = Vector(-1.8422, 0.1765, 0.5488)
	SWEP.IronSightsAng_RDS = Vector(-1.3367, -0.0927, 0)
...
SWEP.VElements = {
["suppressor"] = { type = 'Model', model = "models/uprising/attachments/v/muzzles/pistolsilencer.mdl", bone = "tag_flash", pos = Vector(-0.3, 0.1, 0.05), angle = Angle(), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["laser"] = { type = 'Model', model = "models/uprising/attachments/v/lams/pistollaser.mdl", bone = "j_gun", pos = Vector(4.611, 0, 0.7115), angle = Angle(), size = Vector(0.7236, 0.7236, 0.7236), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["rmr"] = { type = 'Model', model = "models/uprising/attachments/v/rds/rmrpistol.mdl", bone = "j_bolt", pos = Vector(0.09, 0, -0.2875), angle = Angle(), size = Vector(0.8452, 0.8452, 0.8452), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["rds"] = { type = 'Model', model = "models/uprising/attachments/v/rds/pistolrds.mdl", bone = "j_bolt", pos = Vector(-0.3007, 0, -0.0255), angle = Angle(), size = Vector(0.8044, 0.8044, 0.8044), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
