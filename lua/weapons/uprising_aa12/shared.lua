...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("UPRISING_AA12.Fire") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.IronAccuracy = .13 -- Ironsight accuracy, should be the same for shotguns
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/shotguns/c_aa12.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/shotguns/w_aa12.mdl" -- Weapon world model path
...
SWEP.IronSightTime = 0.4
	...
	SWEP.IronSightsPos = Vector(-3.2241, -1.3408, 0.1)
	SWEP.IronSightsAng = Vector(0.2393, 0.0111, 0)

	SWEP.IronSightsPos_RDS = Vector(-3.2136, 0.9389, 0.3763)
	SWEP.IronSightsAng_RDS = Vector()

	SWEP.IronSightsPos_EOTECHL3 = Vector(-3.2143, -1.5441, 0.2534)
	SWEP.IronSightsAng_EOTECHL3 = Vector()

	SWEP.IronSightsPos_AIMP = Vector(-3.2208, -1.3523, 0.6847)
	SWEP.IronSightsAng_AIMP = Vector()

	SWEP.IronSightsPos_TF = Vector(-3.215, -5.5879, 0.3723)
	SWEP.IronSightsAng_TF = Vector()

	SWEP.IronSightsPos_ELCAN = Vector(-3.2163, 0.1365, 0.5709)
	SWEP.IronSightsAng_ELCAN = Vector()


	SWEP.IronSightsPos_ACOG = Vector(-3.2207, -2.0676, 0.4892)
	SWEP.IronSightsAng_ACOG = Vector()


	SWEP.IronSightsPos_HAMR = Vector(-3.2201, -3.5452, 0.5804)
	SWEP.IronSightsAng_HAMR = Vector()

	SWEP.AltPos_HAMR = Vector(0, -2, -1.4)
	SWEP.AltAng_HAMR = Vector()

	SWEP.AltPos_ELCAN = Vector( 0, -3, -1.025 )
...
SWEP.WorldModelBoneMods = {
	["muzzle"] = { scale = Vector(0.6,0.6,0.6), pos = Vector(0, 0, -0), angle = Angle(0, 0, 90) },
	["laser"] = { scale = Vector(1,1,1), pos = Vector(-3, 0.4, 0), angle = Angle(0, 0, 0) },
...
SWEP.VElements = {
["acog"] = { type = 'Model', model = "models/uprising/attachments/v/optics/acogmoh.mdl", bone = "tag_eotech", pos = Vector(-2, 0, -0.3), angle = Angle(), size = Vector(1.2,1.2,1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["elcan"] = { type = 'Model', model = "models/uprising/attachments/v/optics/elcan.mdl", bone = "tag_eotech", pos = Vector(-2, 0, -0.3), angle = Angle(), size = Vector(1.2,1.2,1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["hamr"] = { type = 'Model', model = "models/uprising/attachments/v/optics/hybrid.mdl", bone = "tag_eotech", pos = Vector(-2, 0, -0.1), angle = Angle(), size = Vector(1.2,1.2,1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["rds"] = { type = 'Model', model = "models/uprising/attachments/v/rds/bo2rds.mdl", bone = "tag_eotech", pos = Vector(-2, 0, -0.3), angle = Angle(), size = Vector(1.2,1.2,1.2),  color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["aimpoint"] = { type = 'Model', model = "models/uprising/attachments/v/rds/aimpoint.mdl", bone = "tag_eotech", pos = Vector(-2, 0, -0.3), angle = Angle(), size = Vector(1.2,1.2,1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["eotechl3"] = { type = 'Model', model = "models/uprising/attachments/v/rds/eotechl3.mdl", bone = "tag_eotech", pos = Vector(-2, 0, -0.3), angle = Angle(), size = Vector(1.2,1.2,1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["targetfinder"] = { type = 'Model', model = "models/uprising/attachments/v/rds/targetfinder.mdl", bone = "tag_eotech", pos = Vector(-2, 0, -0.3), angle = Angle(), size = Vector(1.2,1.2,1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["suppressor"] = { type = 'Model', model = "models/uprising/attachments/v/muzzles/shotgunsilencer.mdl", bone = "tag_flash", pos = Vector(-2, 0, -0.1), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["laser"] = { type = 'Model', model = "models/uprising/attachments/v/lams/riflelaser.mdl", bone = "j_gun", pos = Vector(18, -0.9, 2.6131), angle = Angle(90, 0, -90), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
