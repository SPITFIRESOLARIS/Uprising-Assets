...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("UPRISING_M40A5.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("UPRISING_M40A5.Firesil") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/snipers/c_m40a5.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/snipers/w_m40a5.mdl" -- Weapon world model path
...
SWEP.IronSightsAng = Vector()
	...
	SWEP.IronSightsPos_DS = Vector(-4.3435, -6.9016, 1.0582)
...
SWEP.VElements = {
["defaultscope"] = { type = 'Model', model = "models/uprising/attachments/v/scopes/scope.mdl", bone = "tag_acog", pos = Vector(0, 0, 0.1), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
