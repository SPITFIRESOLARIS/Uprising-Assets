...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("UPRISING_M16.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("UPRISING_M16.Firesil") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.RPM_Burst = 950 -- RPM for burst fire, overrides semi.  This is in Rounds Per Minute / RPM
SWEP.Primary.DryFireDelay = nil --How long you have to wait after firing your last shot before a dryfire animation can play.  Leave nil for full empty attack length.  Can also use SWEP.StatusLength[ ACT_VM_BLABLA ]
SWEP.Primary.BurstDelay = 0.09 -- Delay between bursts, leave nil to autocalculate
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/ars/c_m16.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/ars/w_m16.mdl" -- Weapon world model path
...
SWEP.WorldModelBoneMods = {
	...
	["laser"] = { scale = Vector(1,1,1), pos = Vector(-0, .5, 0), angle = Angle(0, 0, 0) },
...
[ACT_VM_RELOAD] = {0., 0.75},
[ACT_VM_RELOAD_EMPTY] = {0., 0.88},
--[ACT_VM_DRAW] = {0.1, 1},
