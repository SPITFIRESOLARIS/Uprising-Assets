...
SWEP.Primary.Round = "uprising_m67_thrown" --Force value, leave nil to autocalc
...
SWEP.NadeTimer = 5
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/lethals/c_m67.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/lethals/w_m67.mdl" -- Weapon world model path
