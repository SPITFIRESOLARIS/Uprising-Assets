...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("UPRISING_MSR.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("UPRISING_MSR.Firesil") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.RangeFalloff = 60 -- The percentage of the range the bullet damage starts to fall off at.  Set to 0.8, for example, to start falling off after 80% of the range.
--Penetration Related
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/snipers/c_msr.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/snipers/w_msr.mdl" -- Weapon world model path
...
SWEP.IronSightsAng = Vector()
	...
	SWEP.IronSightsPos_DS = Vector(-2.3386, -3.362, 0.299)
...
SWEP.VElements = {
["defaultscope"] = { type = 'Model', model = "models/uprising/attachments/v/scopes/scope.mdl", bone = "sight", pos = Vector(-1.3029, -.05, 0.037), angle = Angle(), size = Vector(0.7311, 0.7311, 0.7311), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["acog"] = { type = 'Model', model = "models/uprising/attachments/v/optics/acog.mdl", bone = "sight", pos = Vector(-2, 0, -0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["elcan"] = { type = 'Model', model = "models/uprising/attachments/v/optics/elcan.mdl", bone = "sight", pos = Vector(-2, 0, -0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["hamr"] = { type = 'Model', model = "models/uprising/attachments/v/optics/hybrid.mdl", bone = "sight", pos = Vector(-2, 0, -0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["suppressor"] = { type = 'Model', model = "models/uprising/attachments/v/muzzles/snipersilencer.mdl", bone = "muzzle", pos = Vector(0, 0, 0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
...
if CLIENT then
	...
	function SWEP:Think2()
		...
		local transitionTime = 55 - ( self:GetStat( "IronSightTime" ) * 10 )
		...
		if self.IronSightsProgress > 0.3 then
			...
			self.ogviewmodelfov = math.Approach( self.ogviewmodelfov, self:GetStat( "OGViewModelFOV", 70 ), FrameTime() * 55 )
