...
SWEP.PrintName				= "M4 Super 90"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("UPRISING_SUPER90.Fire") -- This is the sound of the weapon, when you shoot.
...
SWEP.Primary.IronAccuracy = .14 -- Ironsight accuracy, should be the same for shotguns
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/shotguns/c_super90.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/shotguns/w_super90.mdl" -- Weapon world model path
...
SWEP.IronSightTime = 0.4
	...
	SWEP.IronSightsPos = Vector(-2.9041, -0.4601, 1.589)
	SWEP.IronSightsAng = Vector(0.2393, 0.0111, 0)

	SWEP.IronSightsPos_RDS = Vector(-2.906, -1.1549, 0.6996)
	SWEP.IronSightsAng_RDS = Vector()

	SWEP.IronSightsPos_EOTECHL3 = Vector(-2.8949, -3.002, 0.5164)
	SWEP.IronSightsAng_EOTECHL3 = Vector()

	SWEP.IronSightsPos_AIMP = Vector(-2.8903, -1.6858, 0.8676)
	SWEP.IronSightsAng_AIMP = Vector()

	SWEP.IronSightsPos_TF = Vector(-2.8991, -7.7823, 0.7344)
	SWEP.IronSightsAng_TF = Vector()

	SWEP.IronSightsPos_ELCAN = Vector(-2.8885, -1.9522, 0.7974)
	SWEP.IronSightsAng_ELCAN = Vector()


	SWEP.IronSightsPos_ACOG = Vector(-2.8957, -3.6234, 0.7169)
	SWEP.IronSightsAng_ACOG = Vector()


	SWEP.IronSightsPos_HAMR = Vector(-2.898, -4.4057, 0.8616)
...
SWEP.StatusLengthOverride = {["reload_startgrip"] = 0.45, ["reload_start"] = 0.45, } --Changes the status delay of a given animation; only used on reloads.  Otherwise, use SequenceLengthOverride or one of the others
...
SWEP.WorldModelBoneMods = {
	["muzzle"] = { scale = Vector(0.9,0.9,0.9), pos = Vector(0, 0, -0), angle = Angle(0, 0, 90) },
...
SWEP.VElements = {
["acog"] = { type = 'Model', model = "models/uprising/attachments/v/optics/acogmoh.mdl", bone = "tag_reflex", pos = Vector(-1, 0, -0.1), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["elcan"] = { type = 'Model', model = "models/uprising/attachments/v/optics/elcan.mdl", bone = "tag_reflex", pos = Vector(-1, 0, -0.1), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["hamr"] = { type = 'Model', model = "models/uprising/attachments/v/optics/hybrid.mdl", bone = "tag_reflex", pos = Vector(-1, 0, -0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["rds"] = { type = 'Model', model = "models/uprising/attachments/v/rds/bo2rds.mdl", bone = "tag_reflex", pos = Vector(-1, 0, -0.2), angle = Angle(), size = Vector(1,1,1),  color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["aimpoint"] = { type = 'Model', model = "models/uprising/attachments/v/rds/aimpoint.mdl", bone = "tag_reflex", pos = Vector(-1, 0, -0.1), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["eotechl3"] = { type = 'Model', model = "models/uprising/attachments/v/rds/eotechl3.mdl", bone = "tag_reflex", pos = Vector(-1, 0, -.1), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["targetfinder"] = { type = 'Model', model = "models/uprising/attachments/v/rds/targetfinder.mdl", bone = "tag_reflex", pos = Vector(-1, 0, -0.2), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
...
["laser"] = { type = 'Model', model = "models/uprising/attachments/v/lams/riflelaser.mdl", bone = "j_gun", pos = Vector(15.9801, -0.7617, 2.6131), angle = Angle(90, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
...
SWEP.Attachments = {
	...
	[4] = { 
	header = "Underbarrel",
	offset = { 0, 0 }, atts = { "uprising_gripanim", "uprising_afganim" }, order = 4 },
	[5] = {
	header = "Weapon Mods",
