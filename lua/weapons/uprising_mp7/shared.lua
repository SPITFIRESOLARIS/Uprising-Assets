...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("UPRISING_MP7.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("UPRISING_MP7.Firesil") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/smgs/c_mp7.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/smgs/w_mp7.mdl" -- Weapon world model path
...
SWEP.IronSightTime = 0.4
	...
	SWEP.IronSightsPos_RDS = Vector(-3.6745, -2.4231, 0.1027)
	SWEP.IronSightsAng_RDS = Vector()

	SWEP.IronSightsPos_EOTECHL3 = Vector(-3.6637, -3.948, -0.1043)
	SWEP.IronSightsAng_EOTECHL3 = Vector()

	SWEP.IronSightsPos_AIMP = Vector(-3.671, -3.3956, 0.2802)
	SWEP.IronSightsAng_AIMP = Vector()

	SWEP.IronSightsPos_TF = Vector(-3.6618, -7.2919, 0.0231)
	SWEP.IronSightsAng_TF = Vector()

	SWEP.IronSightsPos_ELCAN = Vector(-3.6732, -3.0671, 0.184)
	SWEP.IronSightsAng_ELCAN = Vector()


	SWEP.IronSightsPos_ACOG = Vector(-3.6737, -3.9011, 0.1121)
	SWEP.IronSightsAng_ACOG = Vector()

	SWEP.IronSightsPos_HAMR = Vector(-3.6721, -3.8909, 0.2566)
...
["suppressor"] = { type = 'Model', model = "models/uprising/attachments/v/muzzles/smgsilencer.mdl", bone = "tag_flash", pos = Vector(-4, 0, 0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["laser"] = { type = 'Model', model = "models/uprising/attachments/v/lams/riflelaser.mdl", bone = "j_gun", pos = Vector(5.4833, -0.8962, 0.4627), angle = Angle(90, 90, 180), size = Vector(0.943, 0.943, 0.943), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
...
["laser_beam"] = { type = "Model", model = "models/tfa/lbeam.mdl", bone = "beam", rel = "laser", pos = Vector(0.9,0,0.9), angle = Angle(0, 90, 0), size = Vector(2, 0.5, 0.5), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}, bonemerge = false, active = false }
