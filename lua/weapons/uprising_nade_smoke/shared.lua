...
SWEP.PrintName				= "M18 Smoke Grenade"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.ProjectileVelocity = 900 -- Entity Velocity

--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = "" -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = "" -- This is the sound of the weapon, when silenced.
SWEP.Primary.PenetrationMultiplier = 1 --Change the amount of something this gun can penetrate through
SWEP.Primary.Damage = 65 -- Damage, in standard damage points.
SWEP.Primary.DamageTypeHandled = true --true will handle damagetype in base
SWEP.Primary.DamageType = nil --See DMG enum.  This might be DMG_SHOCK, DMG_BURN, DMG_BULLET, etc.  Leave nil to autodetect.  DMG_AIRBOAT opens doors.
SWEP.Primary.Round = "uprising_smoke_thrown" --Force value, leave nil to autocalc
...
SWEP.Primary.Ammo = "grenade" -- What kind of ammo.  Options, besides custom, include pistol, 357, smg1, ar2, buckshot, slam, SniperPenetratedRound, and AirboatGun.
...
SWEP.NadeTimer = 3
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/lethals/c_smoke.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/lethals/w_smoke.mdl" -- Weapon world model path
...
--[[INSPECTION]]--
SWEP.InspectPos = Vector(5.906, -1.93, 2.217)
SWEP.InspectAng = Vector(9.307, 47.27, 22.927)
--[[VIEWMODEL ANIMATION HANDLING]]--
SWEP.AllowViewAttachment = true --Allow the view to sway based on weapon attachment while reloading or drawing, IF THE CLIENT HAS IT ENABLED IN THEIR CONVARS.
--[[VIEWMODEL BLOWBACK]]--
SWEP.BlowbackEnabled = false --Enable Blowback?
SWEP.BlowbackVector = Vector(0,-0.6,0) --Vector to move bone <or root> relative to bone <or view> orientation.
...
SWEP.ViewModelBoneMods = {
	["l_upperarm"] = { scale = Vector(0.755, 0.755, 0.755), pos = Vector(0.1, 0.16, 0.2), angle = Angle(0, 0, 0) },
	["r_upperarm"] = { scale = Vector(0.755, 0.755, 0.755), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }
}
