...
SWEP.PrintName				= "HK-416A5"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("UPRISING_HK416.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("UPRISING_HK416.Firesil") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/ars/c_hk416.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/ars/w_hk416.mdl" -- Weapon world model path
...
SWEP.IronSightTime = 0.4
	...
	SWEP.IronSightsPos = Vector(-3.5406, -2.6875, 0.6187)
	SWEP.IronSightsAng = Vector(0.2304, 0.0111, 0)

	SWEP.IronSightsPos_RDS = Vector(-3.5337, -3.8103, 0.8048)
	SWEP.IronSightsAng_RDS = Vector()

	SWEP.IronSightsPos_EOTECHL3 = Vector(-3.53, -4.3815, 0.5998)
	SWEP.IronSightsAng_EOTECHL3 = Vector()

	SWEP.IronSightsPos_AIMP = Vector(-3.5284, -3.5793, 0.9909)
	SWEP.IronSightsAng_AIMP = Vector()

	SWEP.IronSightsPos_TF = Vector(-3.5335, -6.6173, 0.8129)
	SWEP.IronSightsAng_TF = Vector()

	SWEP.IronSightsPos_ELCAN = Vector(-3.5371, -3.993, 0.9084)
	SWEP.IronSightsAng_ELCAN = Vector()

	SWEP.IronSightsPos_ACOG = Vector(-3.5293, -4.9744, 0.8187)
	SWEP.IronSightsAng_ACOG = Vector()

	SWEP.IronSightsPos_HAMR = Vector(-3.5386, -5.1327, 1.078)
	SWEP.IronSightsAng_HAMR = Vector()



	SWEP.IronSightsPos_COMPM4 = Vector(-2.2127, 1.1399, -0.3014)
...
SWEP.ViewModelBoneMods = {
	...
	["r_upperarm"] = { scale = Vector(1,1,1), pos = Vector(0,0,0), angle = Angle(0, 0, 0) }
}
...
["hamr"] = { type = 'Model', model = "models/uprising/attachments/v/optics/hybrid.mdl", bone = "sight", pos = Vector(-0, 0, -0.15), angle = Angle(), size = Vector(0.9,0.9,0.9), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["rds"] = { type = 'Model', model = "models/uprising/attachments/v/rds/bo2rds.mdl", bone = "sight", pos = Vector(-0, 0, -0.15), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["aimpoint"] = { type = 'Model', model = "models/uprising/attachments/v/rds/aimpoint.mdl", bone = "sight", pos = Vector(0, 0, -0.1), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["compm4"] = { type = 'Model', model = "models/uprising/attachments/v/rds/compm4.mdl", bone = "sight", pos = Vector(0, 0, -0.16), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["eotechl3"] = { type = 'Model', model = "models/uprising/attachments/v/rds/eotechl3.mdl", bone = "sight", pos = Vector(0, 0, -0.15), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["targetfinder"] = { type = 'Model', model = "models/uprising/attachments/v/rds/targetfinder.mdl", bone = "sight", pos = Vector(0, 0, -0.1), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["suppressor"] = { type = 'Model', model = "models/uprising/attachments/v/muzzles/riflesilencer.mdl", bone = "muzzle", pos = Vector(-1, 0, 0), angle = Angle(), size = Vector(0.8,0.8,0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["laser"] = { type = 'Model', model = "models/uprising/attachments/v/lams/riflelaser.mdl", bone = "j_gun", pos = Vector(15.8132, -1.5051, -0.1784), angle = Angle(90, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
...
["afg"] = { type = 'Model', model = "models/uprising/attachments/v/grips/afg.mdl", bone = "grip", pos = Vector(0, 0, 0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
...
SWEP.InspectBoneMods = {
	["r_upperarm"] = { scale = Vector(1,1,1), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["l_upperarm"] = { scale = Vector(1,1,1), pos = Vector(-8, 10, -5), angle = Angle(0, 0, 0) }
}
...
-- 		lerpProgress = Lerp( FrameTime() * 0.001, self.InspectingProgress, lerpProgress )
