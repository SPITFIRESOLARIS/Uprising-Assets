...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("UPRISING_FAMAS.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("UPRISING_FAMAS.Firesil") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.BurstDelay = 0.06 -- Delay between bursts, leave nil to autocalculate
...
SWEP.Primary.KickDown = 0.255 -- This is the maximum downwards recoil (skeet)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/ars/c_famas.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/ars/w_famas.mdl" -- Weapon world model path
...
SWEP.IronSightTime = 0.4
	...
	SWEP.IronSightsPos = Vector(-3.4729, -5.0881, -0.2171)
	SWEP.IronSightsAng = Vector(0.1278, 0.0111, 0)

	SWEP.IronSightsPos_RDS = Vector(-3.4759, -3.8103, -0.2811)
	SWEP.IronSightsAng_RDS = Vector()

	SWEP.IronSightsPos_EOTECHL3 = Vector(-3.4839, -4.3815, -0.4902)
	SWEP.IronSightsAng_EOTECHL3 = Vector()

	SWEP.IronSightsPos_AIMP = Vector(-3.4763, -3.5793, -0.1061)
	SWEP.IronSightsAng_AIMP = Vector()

	SWEP.IronSightsPos_TF = Vector(-3.4884, -7.4569, -0.2762)
	SWEP.IronSightsAng_TF = Vector()

	SWEP.IronSightsPos_ELCAN = Vector(-3.4705, -3.993, -0.2166)
	SWEP.IronSightsAng_ELCAN = Vector()


	SWEP.IronSightsPos_ACOG = Vector(-3.4733, -5.5269, -0.2933)
	SWEP.IronSightsAng_ACOG = Vector()

	SWEP.IronSightsPos_HAMR = Vector(-3.475, -5.6852, -0.0482)
	SWEP.IronSightsAng_HAMR = Vector()

	SWEP.AltPos_HAMR = Vector(0, -2, -1.18)
...
SWEP.WorldModelBoneMods = {
	...
	["laser"] = { scale = Vector(0.8,0.8,0.8), pos = Vector(-0.3, 0, 0), angle = Angle(0, 0, 0) },
...
SWEP.VElements = {
["acog"] = { type = 'Model', model = "models/uprising/attachments/v/optics/acogmoh.mdl", bone = "tag_eotech", pos = Vector(1, 0, -0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["elcan"] = { type = 'Model', model = "models/uprising/attachments/v/optics/elcan.mdl", bone = "tag_eotech", pos = Vector(1, 0, -0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["hamr"] = { type = 'Model', model = "models/uprising/attachments/v/optics/hybrid.mdl", bone = "tag_eotech", pos = Vector(1, 0, -0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["rds"] = { type = 'Model', model = "models/uprising/attachments/v/rds/bo2rds.mdl", bone = "tag_eotech", pos = Vector(1, 0, -0.1), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["aimpoint"] = { type = 'Model', model = "models/uprising/attachments/v/rds/aimpoint.mdl", bone = "tag_eotech", pos = Vector(1, 0, -0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["eotechl3"] = { type = 'Model', model = "models/uprising/attachments/v/rds/eotechl3.mdl", bone = "tag_eotech", pos = Vector(1, 0, -0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["targetfinder"] = { type = 'Model', model = "models/uprising/attachments/v/rds/targetfinder.mdl", bone = "tag_eotech", pos = Vector(1, 0, -0.1), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
...
["laser"] = { type = 'Model', model = "models/uprising/attachments/v/lams/riflelaser.mdl", bone = "j_gun", pos = Vector(9.5236, -0.518, 3.3451), angle = Angle(90, 0, -90), size = Vector(0.733, 0.733, 0.733), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
