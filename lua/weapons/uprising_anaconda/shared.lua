...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("UPRISING_ANACONDA.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("UPRISING_USP45.Firesil") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/pistols/c_anaconda.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/pistols/w_anaconda.mdl" -- Weapon world model path
...
SWEP.IronSightTime = 0.4
	...
	SWEP.IronSightsPos = Vector(-1.6746, 5.8606, 0.7114)
	SWEP.IronSightsAng = Vector(0.0478, -0.0474, 0)

	SWEP.IronSightsPos_RMR = Vector(-1.6749, 3.5208, 0.2647)
	SWEP.IronSightsAng_RMR = Vector()

	SWEP.IronSightsPos_RDS = Vector(-1.6665, 2.013, -0.0927)
...
SWEP.WorldModelBoneMods = {
	...
	["laser"] = { scale = Vector(0.6,0.6,0.6), pos = Vector(0.1, 0, 0.1), angle = Angle(0, 0, 0) },
}


SWEP.VElements = {
["rds"] = { type = 'Model', model = "models/uprising/attachments/v/rds/pistolrds.mdl", bone = "tag_reflex", pos = Vector(0.5,0,0), angle = Angle(), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["laser"] = { type = 'Model', model = "models/uprising/attachments/v/lams/pistollaser.mdl", bone = "j_gun", pos = Vector(3.4308, 0, -0.7861), angle = Angle(), size = Vector(0.7236, 0.7236, 0.7236), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["rmr"] = { type = 'Model', model = "models/uprising/attachments/v/rds/rmrpistol.mdl", bone = "tag_reflex", pos = Vector(0,0,0), angle = Angle(), size = Vector(0.8452, 0.8452, 0.8452), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["suppressor"] = { type = 'Model', model = "models/uprising/attachments/v/muzzles/pistolsilencer.mdl", bone = "tag_flash", pos = Vector(0, 0, 0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
