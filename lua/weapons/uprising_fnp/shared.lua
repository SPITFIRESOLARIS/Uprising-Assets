...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("UPRISING_FNP.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("UPRISING_PISTOL.FireSil") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/pistols/c_fnp.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/pistols/w_fnp.mdl" -- Weapon world model path
...
SWEP.IronSightTime = 0.3
	...
	SWEP.IronSightsPos = Vector(-2.4779, 2.542, 0.5181)
	SWEP.IronSightsAng = Vector(0.1058, 0.0389, 0)

	SWEP.IronSightsPos_RMR = Vector(-2.4967, 1.9064, 0.319)
	SWEP.IronSightsAng_RMR = Vector()

	SWEP.IronSightsPos_RDS = Vector(-2.5023, 0.8047, 0.0084)
...
SWEP.WorldModelBoneMods = {
	["sight"] = { scale = Vector(0.8,0.8,0.8), pos = Vector(0.1, 0, -0.2), angle = Angle(0, 0, 0) },
	["muzzle"] = { scale = Vector(0.8,0.8,0.8), pos = Vector(0, 0, -0), angle = Angle(0, 0, 0) },
	["laser"] = { scale = Vector(0.6,0.6,0.6), pos = Vector(0), angle = Angle(0, 0, 0) },
}


SWEP.VElements = {
["rmr"] = { type = 'Model', model = "models/uprising/attachments/v/rds/rmrpistol.mdl", bone = "sight", pos = Vector(0.1549, 0, -0.2173), angle = Angle(), size = Vector(0.7452, 0.7452, 0.7452), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["rds"] = { type = 'Model', model = "models/uprising/attachments/v/rds/pistolrds.mdl", bone = "sight", pos = Vector(0.1798, 0, 0), angle = Angle(), size = Vector(0.7024, 0.7024, 0.7024), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["suppressor"] = { type = 'Model', model = "models/uprising/attachments/v/muzzles/pistolsilencer.mdl", bone = "muzzle", pos = Vector(-0.3722, 0, -0.032), angle = Angle(), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["laser"] = { type = 'Model', model = "models/uprising/attachments/v/lams/pistollaser.mdl", bone = "laser", pos = Vector(0.2,0,-0.8), angle = Angle(0, 0, 0), size = Vector(0.6217, 0.6217, 0.6217), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
