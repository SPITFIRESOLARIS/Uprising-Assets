...
SWEP.PrintName				= "L118A"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("UPRISING_L118A.Fire") -- This is the sound of the weapon, when you shoot.
...
--Range Related
SWEP.Primary.Range = 1  -- L96's affective range is 850 Yards. One foot is 16 source units.  850m = 2550ft.  16 * 2550 = 40800   -- The distance the bullet can travel in source units.  Set to -1 to autodetect based on damage/rpm.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/snipers/c_l118a.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/snipers/w_l118a.mdl" -- Weapon world model path
...
SWEP.Attachments = {
	...
	header = "Sights",
	sel = 1,
	 offset = { 0, 0 }, atts = { "uprising_si_l118a" }, order = 1 },
