...
SWEP.PrintName				= "M-200 Intervention"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("UPRISING_M200.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("UPRISING_M200.Firesil") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/snipers/c_m200.mdl" --Viewmodel path
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/snipers/w_m200.mdl" -- Weapon world model path
...
SWEP.IronSightsAng = Vector()
	...
	SWEP.IronSightsPos_ACOG = Vector(-4.3197, -5.0368, 1.4123)
	SWEP.IronSightsAng_ACOG = Vector(0, 0, 0.3344)
...
SWEP.VElements = {
["acog"] = { type = 'Model', model = "models/uprising/attachments/v/optics/acog.mdl", bone = "tag_eotech", pos = Vector(-2, 0, -0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
...
["suppressor"] = { type = 'Model', model = "models/uprising/attachments/v/muzzles/snipersilencer.mdl", bone = "tag_flash", pos = Vector(0, 0, 0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
...
SWEP.Attachments = {
	...
	header = "Sights",
	sel = 1,
	 offset = { 0, 0 }, atts = { "uprising_si_m200" }, order = 1 },
...
--	 "uprising_si_rds", "uprising_si_eotechl3", "uprising_si_aimpoint",  "uprising_si_targetfinder", "uprising_si_elcan", "uprising_si_acog", "uprising_si_hybrid"
	...
	offset = { 0, 0 }, atts = { "uprising_laserm200" }, order = 3 },	
	[4] = {
	header = "Weapon Mods",
