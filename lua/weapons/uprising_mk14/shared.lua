...
SWEP.PrintName				= "MK-14"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("UPRISING_MK14.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("UPRISING_MK14.Firesil") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/ars/c_mk14.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/ars/w_mk14.mdl" -- Weapon world model path
...
SWEP.IronSightTime = 0.4
	...
	SWEP.IronSightsPos_RDS = Vector(-3.8776, -5.0309, 0.3206)
	SWEP.IronSightsAng_RDS = Vector()

	SWEP.IronSightsPos_EOTECHL3 = Vector(-3.891, -6.732, 0.2219)
	SWEP.IronSightsAng_EOTECHL3 = Vector()

	SWEP.IronSightsPos_AIMP = Vector(-3.8839, -5.3347, 0.5837)
	SWEP.IronSightsAng_AIMP = Vector()

	SWEP.IronSightsPos_TF = Vector(-3.8902, -11.2087, 0.3065)
	SWEP.IronSightsAng_TF = Vector()

	SWEP.IronSightsPos_ELCAN = Vector(-3.8861, -5.6685, 0.4971)
	SWEP.IronSightsAng_ELCAN = Vector()


	SWEP.IronSightsPos_ACOG = Vector(-3.8844, -8.5611, 0.5221)
	SWEP.IronSightsAng_ACOG = Vector()


	SWEP.IronSightsPos_HAMR = Vector(-3.8854, -8.0931, 0.6627)
	SWEP.IronSightsAng_HAMR = Vector()

	SWEP.IronSightsPos_MK14 = Vector(-3.8881, -4.8207, 0.5165)
	SWEP.IronSightsAng_MK14 = Vector()
...
SWEP.VElements = {
["acog"] = { type = 'Model', model = "models/uprising/attachments/v/optics/acogmoh.mdl", bone = "tag_eotech", pos = Vector(-0, 0, -0.2), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
...
["laser"] = { type = 'Model', model = "models/uprising/attachments/v/lams/riflelaser.mdl", bone = "j_gun", pos = Vector(20.5063, -1.3854, 2.1346), angle = Angle(90, 0, -90), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
...
SWEP.Attachments = {
	...
	[1] = {
	header = "Sights",
	 offset = { 0, 0 }, atts = { "uprising_si_rds", "uprising_si_eotechl3", "uprising_si_aimpoint",  "uprising_si_targetfinder", "uprising_si_elcan", "uprising_si_acog", "uprising_si_hybrid", "uprising_si_mk14" }, order = 1 },
	[2] = {
	header = "Barrel",
