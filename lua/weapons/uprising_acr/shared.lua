...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("UPRISING_ACR.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("UPRISING_ACR.Firesil") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/ars/c_acr.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/ars/w_acr.mdl" -- Weapon world model path
...
SWEP.IronSightTime = 0.4
	...
	SWEP.IronSightsPos_ACOG = Vector(-3.5372, -4.9744, 0.8313)
	...
	SWEP.AltPos_HAMR = Vector(0, -2, -1.175)
