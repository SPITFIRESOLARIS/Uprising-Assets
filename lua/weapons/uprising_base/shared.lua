...
SWEP.OGViewModelFOV			= SWEP.ViewModelFOV		-- This controls how big the viewmodel looks.  Less is more.
SWEP.AimViewModelFOV			= 70		-- This controls how big the viewmodel looks.  Less is more.
...
SWEP.InspectBoneMods = SWEP.ViewModelBoneMods
...
local function LerpBoneMods( t, b1, b2 )
	...
	for k,v in pairs(b2) do
		...
		if !tbl[k].scale then continue end
...
function SWEP:Think2()
	...
	if CLIENT then
		...
		if !originalHands then

			originalHands = self:GetStat( "ViewModelBoneMods" )

		end

		if self.InspectingProgress and self.InspectingProgress > 0.1 then

			desiredBoneMods = self:GetStat( "InspectBoneMods" ) or self:GetStat( "ViewModelBoneMods" )
			oldBoneMods = self:GetStat( "ViewModelBoneMods" )
		...
		self.ViewModelBoneMods = LerpBoneMods( FrameTime() * 30, oldBoneMods, desiredBoneMods )
