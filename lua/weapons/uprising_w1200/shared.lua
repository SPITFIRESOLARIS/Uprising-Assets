...
SWEP.PrintName				= "Model 1200"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("UPRISING_W1200.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("UPRISING_AA12.Firesil") -- This is the sound of the weapon, when silenced.
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/shotguns/c_w1200.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/shotguns/w_1200.mdl" -- Weapon world model path
...
SWEP.ShellTime = .66 -- For shotguns, how long it takes to insert a shell.
--[[SPRINTING]]--
...
SWEP.IronSightTime = 0.4
	...
	SWEP.IronSightsPos = Vector(-2.8908, -1.7535, 1.1825)
	SWEP.IronSightsAng = Vector(0.5464, 0.0111, 0)

	SWEP.IronSightsPos_RDS = Vector(-2.9048, -3.1121, 0.35)
	SWEP.IronSightsAng_RDS = Vector()

	SWEP.IronSightsPos_EOTECHL3 = Vector(-2.8794, -4.4325, 0.1194)
	SWEP.IronSightsAng_EOTECHL3 = Vector()

	SWEP.IronSightsPos_AIMP = Vector(-2.9102, -4.0525, 0.5096)
	SWEP.IronSightsAng_AIMP = Vector()

	SWEP.IronSightsPos_TF = Vector(-2.8758, -10.099, 0.2418)
	SWEP.IronSightsAng_TF = Vector()

	SWEP.IronSightsPos_ELCAN = Vector(-2.8951, -3.8832, 0.4223)
	SWEP.IronSightsAng_ELCAN = Vector()


	SWEP.IronSightsPos_ACOG = Vector(-2.8938, -4.8994, 0.4465)
	SWEP.IronSightsAng_ACOG = Vector()


	SWEP.IronSightsPos_HAMR = Vector(-2.8986, -5.805, 0.4904)
...
SWEP.LuaShellEjectDelay = 0.4 --The delay to actually eject things
...
SWEP.WorldModelBoneMods = {
	["muzzle"] = { scale = Vector(1,1,1), pos = Vector(0, 0, -0), angle = Angle(0, 0, 90) },
	["laser"] = { scale = Vector(1,1,1), pos = Vector(0, 0, -0.2), angle = Angle(0, 0, 90) },
}


SWEP.VElements = {
["acog"] = { type = 'Model', model = "models/uprising/attachments/v/optics/acogmoh.mdl", bone = "tag_reflex", pos = Vector(0, 0, -0.2), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["elcan"] = { type = 'Model', model = "models/uprising/attachments/v/optics/elcan.mdl", bone = "tag_reflex", pos = Vector(-0, 0, -0.1), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["hamr"] = { type = 'Model', model = "models/uprising/attachments/v/optics/hybrid.mdl", bone = "tag_reflex", pos = Vector(-0, 0, -0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["rds"] = { type = 'Model', model = "models/uprising/attachments/v/rds/bo2rds.mdl", bone = "tag_reflex", pos = Vector(-0, 0, -0.2), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["aimpoint"] = { type = 'Model', model = "models/uprising/attachments/v/rds/aimpoint.mdl", bone = "tag_reflex", pos = Vector(-0, 0, -0.1), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["eotechl3"] = { type = 'Model', model = "models/uprising/attachments/v/rds/eotechl3.mdl", bone = "tag_reflex", pos = Vector(-0, 0, -0.1), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["targetfinder"] = { type = 'Model', model = "models/uprising/attachments/v/rds/targetfinder.mdl", bone = "tag_reflex", pos = Vector(-0, 0, -0.1), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["suppressor"] = { type = 'Model', model = "models/uprising/attachments/v/muzzles/shotgunsilencer.mdl", bone = "tag_flash", pos = Vector(0, 0, 0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["laser"] = { type = 'Model', model = "models/uprising/attachments/v/lams/riflelaser.mdl", bone = "j_pump", pos = Vector(2, -1, 1), angle = Angle(90, 0, -90), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
...
["reflex"] = { type = 'Model', model = "models/uprising/attachments/v/rds/reflex.mdl", bone = "sight", rel = "ref", pos = Vector(0,0,0), angle = Angle(0,0,0), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {}, bonemerge = true,  active = false },
...
["suppressor"] = { type = 'Model', model = "models/uprising/attachments/v/muzzles/shotgunsilencer.mdl", bone = "muzzle", rel = "ref", pos = Vector(0,0,0), angle = Angle(0,0,0), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {}, bonemerge = true,  active = false },
["laser"] = { type = 'Model', model = "models/uprising/attachments/v/lams/riflelaser.mdl", bone = "laser", rel = "ref", pos = Vector(0,0,900), angle = Angle(0,0,0), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {}, bonemerge = true,  active = false },
...
SWEP.Attachments = {
	...
	[4] = { 
	header = "Underbarrel",
	offset = { 0, 0 }, atts = { "uprising_gripanimw1200", "uprising_afganimw1200" }, order = 4 },
	[5] = {
	header = "Weapon Mods",
...
SWEP.InspectBoneMods = {
	["j_shoulder_ri"] = { scale = Vector(1.1,1.1,1.1), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["j_shoulder_le"] = { scale = Vector(1.1,1.1,1.1), pos = Vector(-8, 10, -5), angle = Angle(0, 0, 0) }
}
