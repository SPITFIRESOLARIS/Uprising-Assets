...
SWEP.PrintName				= "PM-9"		-- Weapon name (Shown on HUD)
...
--[[WEAPON HANDLING]]--
SWEP.Primary.Sound = Sound("UPRISING_PM9.Fire") -- This is the sound of the weapon, when you shoot.
SWEP.Primary.SilencedSound = Sound("UPRISING_PM9.Firesil") -- This is the sound of the weapon, when silenced.
...
SWEP.Primary.SpreadMultiplierMax = 1.1--How far the spread can expand when you shoot. Example val: 2.5
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/smgs/c_pm9.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/smgs/w_pm9.mdl" -- Weapon world model path
...
SWEP.IronSightTime = 0.4
	...
	SWEP.IronSightsPos = Vector(-3.6622, 0.0653, 0.7241)
	SWEP.IronSightsAng = Vector()

	SWEP.IronSightsPos_RDS = Vector(-3.6568, -2.5171, -0.1815)
	SWEP.IronSightsAng_RDS = Vector()

	SWEP.IronSightsPos_EOTECHL3 = Vector(-3.6472, -3.948, -0.2716)
	SWEP.IronSightsAng_EOTECHL3 = Vector()

	SWEP.IronSightsPos_AIMP = Vector(-3.6555, -3.3956, 0.101)
	SWEP.IronSightsAng_AIMP = Vector()

	SWEP.IronSightsPos_TF = Vector(-3.6618, -7.2919, -0.0389)
	SWEP.IronSightsAng_TF = Vector()

	SWEP.IronSightsPos_ELCAN = Vector(-3.659, -4.5188, 0.0036)
	SWEP.IronSightsAng_ELCAN = Vector()


	SWEP.IronSightsPos_ACOG = Vector(-3.6605, -3.6433, -0.0744)
	SWEP.IronSightsAng_ACOG = Vector()


	SWEP.IronSightsPos_HAMR = Vector(-3.6616, -3.8909, 0.0738)
...
SWEP.ViewModelBoneMods = {
	["j_shoulder_ri"] = { scale = Vector(0.9,0.9,0.9), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["j_shoulder_le"] = { scale = Vector(0.9,0.9,0.9), pos = Vector(0,0,0), angle = Angle(0, 0, 0) }
}

SWEP.WorldModelBoneMods = {
	["muzzle"] = { scale = Vector(0.8,0.8,0.8), pos = Vector(-2, 0, -0), angle = Angle(0, 0, 0) },
	["laser"] = { scale = Vector(1,1,1), pos = Vector(-3, 0, 0), angle = Angle(180, 180, 0) },
...
SWEP.VElements = {
["acog"] = { type = 'Model', model = "models/uprising/attachments/v/optics/acogmoh.mdl", bone = "tag_eotech", pos = Vector(2, 0, -0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["elcan"] = { type = 'Model', model = "models/uprising/attachments/v/optics/elcan.mdl", bone = "tag_eotech", pos = Vector(2.5, 0, -0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["hamr"] = { type = 'Model', model = "models/uprising/attachments/v/optics/hybrid.mdl", bone = "tag_eotech", pos = Vector(2, 0, 0.1), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["rds"] = { type = 'Model', model = "models/uprising/attachments/v/rds/bo2rds.mdl", bone = "tag_eotech", pos = Vector(2.5, 0, 0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["aimpoint"] = { type = 'Model', model = "models/uprising/attachments/v/rds/aimpoint.mdl", bone = "tag_eotech", pos = Vector(2.5, 0, -0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["eotechl3"] = { type = 'Model', model = "models/uprising/attachments/v/rds/eotechl3.mdl", bone = "tag_eotech", pos = Vector(2.5, 0, -0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["targetfinder"] = { type = 'Model', model = "models/uprising/attachments/v/rds/targetfinder.mdl", bone = "tag_eotech", pos = Vector(2.5, 0, -0.1), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["suppressor"] = { type = 'Model', model = "models/uprising/attachments/v/muzzles/smgsilencer.mdl", bone = "tag_flash", pos = Vector(0, 0, 0), angle = Angle(), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
["laser"] = { type = 'Model', model = "models/uprising/attachments/v/lams/riflelaser.mdl", bone = "j_gun", pos = Vector(-4.3348, 0.5609, 1.5578), angle = Angle(-90, -90, 0), size = Vector(0.7881, 0.7881, 0.7881), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {},  active = false },
...
["suppressor"] = { type = 'Model', model = "models/uprising/attachments/v/muzzles/smgsilencer.mdl", bone = "muzzle", rel = "ref", pos = Vector(0,0,0), angle = Angle(0,0,0), size = Vector(1,1,1), color = Color(255, 255, 255, 255), surpresslightning = false, material = '', skin = 0, bodygroup = {}, bonemerge = true,  active = false },
...
SWEP.GripBoneMods = {
	...
	["j_shoulder_le"] = { scale = Vector(1, 1, 1), pos = Vector(4.8, 3.151, -1), angle = Angle(0, 0, 0) },
...
SWEP.InspectBoneMods = {
	["j_shoulder_ri"] = { scale = Vector(0.9,0.9,0.9), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) },
	["j_shoulder_le"] = { scale = Vector(0.9,0.9,0.9), pos = Vector(-8, 10, -5), angle = Angle(0, 0, 0) }
}
