...
SWEP.PrintName				= "M84 Stun Grenade"		-- Weapon name (Shown on HUD)
...
SWEP.Primary.Round = "uprising_flash_thrown" --Force value, leave nil to autocalc
...
SWEP.NadeTimer = 1.8
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/uprising/lethals/c_flash.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/uprising/lethals/w_flash.mdl" -- Weapon world model path
...
SWEP.ViewModelBoneMods = {
	["l_upperarm"] = { scale = Vector(0.755, 0.755, 0.755), pos = Vector(0.1, 0.306, 0), angle = Angle(0, 0, 0) },
	["r_upperarm"] = { scale = Vector(0.7, 0.7, 0.7), pos = Vector(0, 0, 0), angle = Angle(0, 0, 0) }
}
