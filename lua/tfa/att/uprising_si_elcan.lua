...
ATTACHMENT.Name = "ELCAN SPECTER"
ATTACHMENT.Description = {TFA.AttachmentColors["="], "3x zoom"}
...
ATTACHMENT.ShortName = "Elcan"
ATTACHMENT.AimPos = "ELCAN"
...
ATTACHMENT.WeaponTable = {
	...
	["IronSightsPos"] = function( wep, val ) return wep.IronSightsPos_ELCAN or val end,
	["IronSightsAng"] = function( wep, val ) return wep.IronSightsAng_ELCAN or val end,
...
local myret = Material("uprising/attachments/reticles/elcan_optic")
