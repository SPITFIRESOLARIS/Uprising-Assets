...
ATTACHMENT.AimPos = "M200"

ATTACHMENT.WeaponTable = {


	["IronSightsPos"] = function( wep, val ) return wep.IronSightsPos_M200 or val end,
	["IronSightsAng"] = function( wep, val ) return wep.IronSightsAng_M200 or val end,
