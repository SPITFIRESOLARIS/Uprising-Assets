...
ATTACHMENT.Name = "Verical Foregrip"
--ATTACHMENT.ID = "base" -- normally this is just your filename
ATTACHMENT.Description = { TFA.AttachmentColors["+"], "Decreases verical Recoil", TFA.AttachmentColors["+"], "Slightly decreases Horizonal Recoil", TFA.AttachmentColors["-"], "Decreased Draw and Holster speed" }
