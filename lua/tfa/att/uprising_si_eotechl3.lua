...
ATTACHMENT.Name = "EOTech L3"
--ATTACHMENT.ID = "base" -- normally this is just your filename
ATTACHMENT.Description = { TFA.AttachmentColors["="], "Provides circle and dot reticle for precise aiming" }
...
ATTACHMENT.AimPos = "EOTECHL3"
ATTACHMENT.elementID = "eotechl3"
ATTACHMENT.reticle = Material( "uprising/attachments/reticles/eotech_rds" )
ATTACHMENT.size = 1.3
...
ATTACHMENT.WeaponTable = {
	...
	["IronSightsPos"] = function( wep, val ) return wep.IronSightsPos_EOTECHL3 or val end,
	["IronSightsAng"] = function( wep, val ) return wep.IronSightsAng_EOTECHL3 or val end,
	-- ["Secondary"] = {
