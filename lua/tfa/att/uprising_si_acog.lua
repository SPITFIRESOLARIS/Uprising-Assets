...
ATTACHMENT.Description = {TFA.AttachmentColors["="], "4x zoom optic"}
ATTACHMENT.Icon = "uprising/atticons/acog.png" --Revers to label, please give it an icon though!  This should be the path to a png, like "entities/tfa_ammo_match.png"
ATTACHMENT.ShortName = "acog"
ATTACHMENT.AimPos = "ACOG"
...
local myret = Material("uprising/attachments/reticles/acog_optic")
