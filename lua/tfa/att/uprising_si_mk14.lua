...
ATTACHMENT.Name = "5X Scope"
ATTACHMENT.Description = {TFA.AttachmentColors["="], "5x zoom", TFA.AttachmentColors["-"], "15% higher zoom time"}
...
ATTACHMENT.WeaponTable = {
	...
	["IronSightsPos"] = function( wep, val ) return wep.IronSightsPos_MK14 or val end,
	["IronSightsAng"] = function( wep, val ) return wep.IronSightsAng_MK14 or val end,
...
local myret = Material("uprising/attachments/reticles/mw3_scope")
