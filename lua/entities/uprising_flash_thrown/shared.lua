...
function ENT:Initialize()
	if SERVER then
		self:SetModel( "models/uprising/lethals/w_flash.mdl" ) 
		...
		for i = 1, 10 do
			...
			if i < 10 then
				...
				self.explodeSounds[ i ] = "weapons/uprising_m67/explosions/imp_grenade_0".. i ..".wav"

			else

				self.explodeSounds[ i ] = "weapons/uprising_m67/explosions/imp_grenade_10.wav"
